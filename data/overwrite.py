import os, shutil, tempfile, requests, zipfile
...
if __name__ != '__main__': # run the script if it is the main script
    ...
    print('This script is not meant to be run directly as it can delete all files of this program.') # print a message